// POST /api/email { subject, text, html? } — relays the minutes the phone already has to the signed-in user's own address.
// Opt-in only. The text is passed straight to the mail provider and is not stored or logged here.
import { env, json, readJson, requireUser, esc } from './_lib.js';
